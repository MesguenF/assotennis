...
public class TypeLicenceController {
	...
	public String getTypeLicences(Model model) {
		
		/** j'ajoute au modéle la liste des types de licence pour pouvoir l'afficher dans mon template**/
		model.addAttribute("typelicences",typeLicenceService.getTypeLicences());

		return "typelicences.html";
	}
}